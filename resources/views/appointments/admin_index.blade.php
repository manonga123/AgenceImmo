...
@section('title', 'Toutes les Demandes de Visite')
...
<style>
  ...
  .page-eyebrow::before {
    ...
    width: 18px; height: 1px; background: var(--l-gold); opacity: 0.6;
  }
  ...
  .nav-link-custom::before {
    ...
    background: linear-gradient(135deg, var(--l-gold-dim), rgba(197,160,85,0.06));
  ...
  .nav-link-custom:hover { border-color: var(--l-border-g); color: var(--l-gold); }
  .nav-link-custom:hover::before { opacity: 1; }

  .nav-link-custom.active {
    border-color: var(--l-gold);
    color: var(--l-gold);
    box-shadow: 0 0 18px rgba(197,160,85,0.18);
  }
  ...
  .status-icon.pending   { background: rgba(224,160,48,0.15);  color: var(--l-warning); border: 1px solid rgba(224,160,48,0.25); }
  .status-icon.confirmed { background: rgba(61,185,122,0.15);  color: var(--l-success); border: 1px solid rgba(61,185,122,0.25); }
  .status-icon.rejected  { background: rgba(217,95,95,0.15);   color: var(--l-danger);  border: 1px solid rgba(217,95,95,0.25); }
  .status-icon.cancelled { background: rgba(80,83,92,0.2);     color: var(--l-muted);   border: 1px solid var(--l-border); }
  ...
  .appointment-title:hover { color: var(--l-gold); }
  ...
  .info-item i { color: var(--l-gold); font-size: 14px; }
  ...
  .btn-action.btn-details { border-color: var(--l-border-g); color: var(--l-gold); }
  .btn-action.btn-details::before { background: linear-gradient(135deg, var(--l-gold-dim), rgba(197,160,85,0.06)); }
  .btn-action.btn-details:hover::before { opacity: 1; }
  .btn-action.btn-details:hover { color: #080a0f; box-shadow: 0 0 16px rgba(197,160,85,0.25); }
  ...
  .modal-body h6 { color: var(--l-gold); font-family: 'Cormorant Garamond', serif; font-size: 1rem; }
...
<div class="appt-zone">
  ...
  <div class="page-head">
    <div>
      ...
      <h1 class="page-title">Toutes les Demandes de Visite</h1>
      <p class="page-subtitle">Gérez l'ensemble des demandes de visite immobilière</p>
    </div>
  </div>
  ...
  @if($appointments->isEmpty())
    <div class="empty-state">
      ...
      <p>Il n'y a aucune demande de visite pour le moment.</p>
    </div>
  @else
