...
<style>
    /* ══════════════════════════════════════════
       DEMANDES CONFIRMÉES — Design System sidebar dark luxury
    ...
    .appointments-title i {
        font-size: 30px;
        color: #6ee8aa;
        filter: drop-shadow(0 0 8px rgba(61,185,122,0.35));
    }
    ...
    .nav-link-custom.active {
        ...
        border-color: rgba(61,185,122,0.32);
        color: #6ee8aa;
        box-shadow: 0 0 14px rgba(61,185,122,0.08);
    }
    ...
    .appointment-card:hover {
        ...
        border-color: rgba(61,185,122,0.26);
        box-shadow: 0 12px 36px rgba(0,0,0,0.4), 0 0 0 1px rgba(61,185,122,0.06);
    }
    ...
    .appointment-message {
        ...
        border-left: 2px solid rgba(61,185,122,0.45);
        padding: 11px 14px;
    ...
    .modal-body .badge.bg-success {
        background: rgba(61,185,122,0.15) !important;
        color: #6ee8aa;
