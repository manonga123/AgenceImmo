...
<style>
    /* ══════════════════════════════════════════
       DEMANDES DE VISITE — Design System sidebar dark luxury
    ...
    .appointments-title i {
        font-size: 30px;
        color: var(--gold);
        filter: drop-shadow(0 0 8px rgba(197,160,85,0.35));
    }
    ...
    .appointment-card:hover {
        ...
        border-color: var(--border-glow);
        box-shadow: 0 12px 36px rgba(0,0,0,0.4), 0 0 0 1px rgba(197,160,85,0.07);
    }
    ...
    .modal-body .badge.bg-danger {
        background: rgba(217,95,95,0.15) !important;
        color: #f09090;
    ...
    .modal-body .badge.bg-secondary {
        background: rgba(80,83,92,0.2) !important;
        color: var(--text-muted);
        border: 1px solid var(--border);
        font-weight: 600;
        font-size: 12px;
