...
<style>
  ...
  .page-head::after {
    ...
    background: linear-gradient(90deg, var(--l-success), transparent);
    opacity: 0.5;
  }
  ...
  .page-eyebrow {
    ...
    color: var(--l-success); margin-bottom: 8px;
    display: flex; align-items: center; gap: 8px;
  }

  .page-eyebrow::before {
    content: ''; display: inline-block;
    width: 18px; height: 1px; background: var(--l-success); opacity: 0.6;
  }
  ...
  .nav-link-custom::before {
    ...
    background: linear-gradient(135deg, rgba(61,185,122,0.18), rgba(61,185,122,0.06));
  ...
  .nav-link-custom:hover { border-color: rgba(61,185,122,0.35); color: var(--l-success); }
  .nav-link-custom:hover::before { opacity: 1; }

  .nav-link-custom.active {
    border-color: rgba(61,185,122,0.55); color: var(--l-success);
    box-shadow: 0 0 18px rgba(61,185,122,0.18);
  }
  ...
  .appointment-card::before {
    ...
    background: linear-gradient(90deg, transparent, var(--l-success), transparent);
    opacity: 0; transition: opacity var(--tr);
  }

  .appointment-card:hover {
    transform: translateY(-4px);
    border-color: rgba(61,185,122,0.25);
  ...
  .appointment-title:hover { color: var(--l-success); }
  ...
  .info-item i { color: var(--l-success); font-size: 14px; }
  .info-item strong { color: var(--l-soft); }

  .appointment-message {
    background: var(--l-surface2);
    border-left: 2px solid var(--l-success);
  ...
  .btn-action.btn-confirmed {
    border-color: rgba(61,185,122,0.35); color: var(--l-success);
    cursor: not-allowed; opacity: 0.6;
  }

  .btn-action.btn-details { border-color: rgba(61,185,122,0.35); color: var(--l-success); }
  .btn-action.btn-details::before { background: linear-gradient(135deg, rgba(61,185,122,0.18), rgba(61,185,122,0.06)); }
  .btn-action.btn-details:hover::before { opacity: 1; }
  .btn-action.btn-details:hover { box-shadow: 0 0 16px rgba(61,185,122,0.2); }
  ...
  .modal-body h6 { color: var(--l-success); font-family: 'Cormorant Garamond', serif; font-size: 1rem; }
...
<div class="appt-zone">
  ...
  <div class="page-head">
    <div>
      ...
      <h1 class="page-title">Demandes Confirmées</h1>
      <p class="page-subtitle">Visites validées et planifiées avec les propriétaires</p>
    </div>
  </div>
  ...
  @if($appointments->isEmpty())
    <div class="empty-state">
      ...
      <p>Il n'y a aucune demande confirmée pour le moment.</p>
    </div>
  @else
        ...
        <div class="appointment-actions">
          ...
          @elseif($appointment->property->owner_id === auth()->id())
            <button class="btn-action btn-confirmed" disabled>
              <i class="bi bi-check-circle-fill"></i> <span>Confirmée</span>
            </button>
          @endif
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="mb-3">
                ...
                <p><span class="badge bg-success"><i class="bi bi-check-circle me-1"></i> Confirmée</span></p>
              </div>
              @if($appointment->message)
              <div class="mb-3">
