...
<style>
  ...
  .existing-img-item:hover img { transform: scale(1.04); }
  ...
  .drop-zone-hint { font-size: 0.72rem; color: var(--c-muted); }
  ...
  .preview-size { font-size: 0.6rem; color: var(--c-muted); }
  ...
  @media (max-width: 576px) {
    ...
    .existing-images-grid { grid-template-columns: 1fr; }
...
<div class="edit-zone">
  ...
  <div class="page-head">
    <div>
      <h1 class="page-title">Modifier la propriété</h1>
      <p class="page-subtitle">Mettez à jour les informations de « {{ $property->title }} »</p>
    </div>
    <a href="{{ route('properties.show', $property->id) }}" class="btn-back">
      ...
      <div>
        ...
        <div class="section-card">
          ...
          <div class="form-group">
            ...
            <textarea class="form-textarea {{ $errors->has('description') ? 'is-invalid' : '' }}"
                      name="description"
          ...
          <div class="form-row cols-3">
            ...
            <div class="form-group">
              ...
              <div class="input-wrap">
                ...
                <input type="number"
                       class="form-input {{ $errors->has('surface') ? 'is-invalid' : '' }}"
                       name="surface"
            ...
            <div class="form-group">
              ...
              <select class="form-select {{ $errors->has('status') ? 'is-invalid' : '' }}"
                ...
                <option value="loué"       {{ old('status', $property->status) == 'loué'       ? 'selected' : '' }}>Loué</option>
              </select>
              @error('status')
                <div class="invalid-msg"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div>
              @enderror
          ...
          <div class="form-row cols-2">
            <div class="form-group">
              ...
              <div class="input-wrap">
                ...
                <input type="number"
                       class="form-input {{ $errors->has('rooms') ? 'is-invalid' : '' }}"
                       name="rooms"
            ...
            <div class="form-group">
              ...
              <div class="input-wrap">
                ...
                <input type="number"
                       class="form-input {{ $errors->has('bathrooms') ? 'is-invalid' : '' }}"
                       name="bathrooms"
        ...
        <div class="upload-card">
          ...
          <div class="upload-body">
            ...
            @if($property->images->count() > 0)
              <div class="existing-section-label">
                Photos actuelles ({{ $property->images->count() }})
              </div>
              <div class="existing-images-grid">
                ...
                <div class="existing-img-item">
                  ...
                  <div class="existing-img-overlay">
                    <div class="existing-img-label">
                      {{ $loop->first ? 'Principale' : 'Photo '.$loop->iteration }}
                    </div>
                  </div>
                </div>
                @endforeach
            ...
            {{-- Drop zone nouvelles images --}}
            <label for="images" class="drop-zone" id="dropZone">
              <div class="drop-zone-icon">
                <i class="bi bi-cloud-upload"></i>
              </div>
              <div class="drop-zone-text">Ajouter de nouvelles photos</div>
              <div class="drop-zone-hint">Cliquez ou glissez-déposez vos fichiers ici</div>
            ...
            <div id="previewSection" class="preview-section" style="display:none;">
              <div class="preview-label">Nouvelles photos</div>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.getElementById('editForm').addEventListener('submit', function (e) {
    ...
    btn.innerHTML = '<i class="bi bi-hourglass-split"></i> <span>Mise à jour en cours…</span>';
    btn.disabled = true;
  });
